...
@property (nonatomic, strong) ___FILEBASENAMEASIDENTIFIER___ViewModel *viewModel;
@end
...
- (___FILEBASENAME___ViewModel *)viewModel {
    if (!_viewModel) {
        _viewModel = [[___FILEBASENAMEASIDENTIFIER___ViewModel alloc] init];
    }
    return _viewModel;
}
@end
